...
"""
We have more datastructure like set , list and tuple which also supports  the above operations but they are not covered in this example because it will cover when that has been taught.
"""